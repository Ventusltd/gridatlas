/**
 * substation-intelligence-v9-63, generation 202609030317 (UTC).
 *
 ...
 * hashed in manifests/202609030317-substation-intelligence-v9-63-parts.json.
 *
 *   carried_shell_script   atlas/parts/202609030317-pipelinenews-arrival-engine.js
...
window.initVentusMap = function({ config, center, zoom }) {
    ...
    async function focusCanonicalProjectDeepLink() {
        ...
        try {
            ...
            /* Pipeline News release 202609030009-pipelinenews emits the four spine
            ...
            const allowedTechnologies = new Set(['act', 'bess', 'biomass', 'caes', 'flywheel', 'geothermal', 'hydro', 'hydrogen', 'other', 'solar', 'tidal', 'wind_offshore', 'wind_onshore']);
