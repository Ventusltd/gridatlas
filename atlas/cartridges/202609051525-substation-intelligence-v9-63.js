/**
 * substation-intelligence-v9-63, generation 202609051525 (UTC).
 *
 ...
 * hashed in manifests/202609051525-substation-intelligence-v9-63-parts.json.
 *
 *   carried_shell_script   atlas/parts/202609040229-ventus-corev8engine-exact-repd-delegation.js
 ...
 *   module                 atlas/modules/202609051525-teleprint-controls.js
 ...
 *
 * Sources:
 *   screen-frame.js  sha256 68ea6ecc5d172364eeff95c05dbc8eb4107986254584a95d780b76c9ec108680
 *   print-pdf.js  sha256 2061594d187f227da3986027837e592d4f3b502b187bd97743c9a1bf1943eb5d
 *   print-source-code.js  sha256 e16610405869da3f0a3e03c90871e6d2ef754ae3a092a181c05f3b75bee59394
 *   gridatlas-wiring.js  sha256 d35f805cac1623bc2bea30e7999ba0da2c706f193ebd9dc7d7787e97bf28aa6d
 */
(function () {
  'use strict';

  /* ---- screen-frame.js (sha256 68ea6ecc5d172364) ---- */
  /**
  ...
  /* ---- print-pdf.js (sha256 2061594d187f227d) ---- */
  /**
  ...
  /* ---- print-source-code.js (sha256 e16610405869da3f) ---- */
  /**
  ...
  function showTeleprintPanel(text, filename, parts) {
    ...
    head.textContent = (parts && parts.length > 1)
      ? filename + ' — volume 1 of ' + parts.length
        + '. Attach this one first; it holds the screen state and the index of'
        + ' every file. The other volumes are below.'
      : filename + ' — select all, copy, and paste into your AI chat.';
  ...
  async function deliverSourceCode(collected, { prefer, panel = true } = {}) {
    const parts = (collected.blocks && collected.header)
      ...
      : [{ filename: collected.filename, text: collected.text, volume: 1, of: 1 }];
    const first = parts[0];
    const record = {
      filename: first.filename,
      bytes: new Blob([collected.text]).size,
      volumes: parts.length,
      volumeBytes: parts.map(part => new Blob([part.text]).size),
    ...
    /* Volume 1 only. Firing five downloads at once is blocked as a popup storm
       in every browser worth naming, and on a phone it is indistinguishable from
       the page misbehaving. The rest are one tap each in the panel. */
    try {
      ...
      'gridatlas-teleprint-source', function () {
        ...
        Promise.resolve(prepared || beginPreparing()).then(function (collected) {
          ...
          say('Source code · ' + receipt.included + ' files, '
            + receipt.bytes + ' bytes'
            + (receipt.volumes > 1
              ? ' · ' + receipt.volumes + ' volumes, attach volume 1 first'
              : '')
            + ' · ' + receipt.via.join(' + ')
