/**
 * substation-intelligence-v9-63, generation 202609051503 (UTC).
 *
 ...
 * hashed in manifests/202609051503-substation-intelligence-v9-63-parts.json.
 *
 ...
 *   module                 atlas/modules/202609051503-teleprint-controls.js
 ...
 *
 * Sources:
 *   screen-frame.js  sha256 e48826f121cc9d2f011351094dc40f14e68b7c4f96d2f95dcc9acabbe8a6ae96
 *   print-pdf.js  sha256 8eac02d8ea3bad87ae8f9609444e75a828617d1e26a36dc42de1f58bcd40ee2e
 *   print-source-code.js  sha256 f60828df12030ad3d25f5baf62ae277dd51270bfaa31239d384b1cb2e8cd1ea6
 *   gridatlas-wiring.js  sha256 7fb9d074cb85bee9df57928835b5aeda8dc0d514df676130f58522a9822ac5e8
 */
(function () {
  'use strict';

  /* ---- screen-frame.js (sha256 e48826f121cc9d2f) ---- */
  /**
  ...
  /* ---- print-pdf.js (sha256 8eac02d8ea3bad87) ---- */
  /**
  ...
  /* ---- print-source-code.js (sha256 f60828df12030ad3) ---- */
  /**
  ...
  async function collectSourceCode({ appName = 'GridAtlas', inlineDom = true } = {}) {
    ...
    included.forEach((item, index) => {
      ...
      lines.push(`     ${item.chars} chars · found via ${item.how}`);
    });
    lines.push('');
    if (missing.length) {
      lines.push(rule);
