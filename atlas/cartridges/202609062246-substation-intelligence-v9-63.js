/**
 * substation-intelligence-v9-63, generation 202609060259 (UTC).
 *
 ...
 * hashed in manifests/202609060259-substation-intelligence-v9-63-parts.json.
 *
 ...
 *   module                 atlas/modules/202609020015-injection-response.js
 ...
 *   module                 atlas/modules/202609030157-version-ledger.js
 *   module                 atlas/modules/202609030205-corridor-estimate.js
 *   module                 atlas/modules/202609031958-menu-bar.js
        ...
        try {
            ...
            const switchOn = () => {
                for (const id of arrivalLayers) {
                    ...
                    document.querySelectorAll(`input[data-layer-id="${id}"]`).forEach(input => { input.checked = true; });
