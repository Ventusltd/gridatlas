/**
 * substation-intelligence-v9-63, generation 202609040046 (UTC).
 *
 ...
 * hashed in manifests/202609040046-substation-intelligence-v9-63-parts.json.
 *
 *   carried_shell_script   atlas/parts/202609040045-ventus-corev8engine-deep-link-receiver.js
...
window.initVentusMap = function({ config, center, zoom }) {
    ...
    async function focusCanonicalProjectDeepLink() {
        ...
        try {
            ...
            /* This legacy receiver owns only the four partitioned spine
               products below. The exact-REPD search cartridge owns every
               other canonical technology. Treating those values as invalid
               made every wider-fleet MAP link throw before the coordinate
               receiver could answer; defer them without fetching all spine
               partitions or manufacturing a false match. */
            const partitionTechnologies = new Set([
                'solar', 'bess', 'wind_onshore', 'wind_offshore'
            ]);
            if (!partitionTechnologies.has(requestedTechnology)) {
