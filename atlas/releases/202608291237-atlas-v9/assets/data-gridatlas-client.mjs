...
export function validateReleaseManifest(manifest, { sealed = true } = {}) {
  ...
  invariant(manifest.release_id === "202608291237-atlas-v9", "application release identity mismatch");
  invariant(manifest.generation === "202608291237", "application generation mismatch");
