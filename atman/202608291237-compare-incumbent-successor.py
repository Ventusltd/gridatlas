...
def main() -> None:
    ...
    sections = {
        ...
        "repd_incumbent_regression": {
            ...
            "golden_deep_link": classified(release.get("route_contract", {}).get("golden_deep_link") == "https://ventusltd.github.io/gridatlas/202608291237-atlas-v9/?repd_ref=16135", release.get("route_contract", {}).get("golden_deep_link"), expected_change=True),
        },
        "lazy_runtime": {
