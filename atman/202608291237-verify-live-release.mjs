...
const RELEASE_ID = "202608291237-atlas-v9";
...
assert(manifest.route_contract.route === "/gridatlas/202608291237-atlas-v9/", "timestamp route contract drift");
assert(manifest.route_contract.query_parameter === "repd_ref", "deep-link query contract drift");
assert(manifest.route_contract.golden_deep_link === "https://ventusltd.github.io/gridatlas/202608291237-atlas-v9/?repd_ref=16135", "deep-link sentinel missing");
