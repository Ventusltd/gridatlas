import './module-compaction-current.proof.mjs';
/**
...
check('the parts manifest preserves Claude259 exact-REPD and grabbable-polygon engine',
  enginePart?.path === 'atlas/parts/202609060254-ventus-corev8engine-polyzone-grabbable.js'
  && enginePart.sha256 === 'f381d6ed28ca3a6556ad59f88339371e66ef290f7e5124a17684660faa07fb16'
  && createHash('sha256').update(engine).digest('hex') === enginePart.sha256);
