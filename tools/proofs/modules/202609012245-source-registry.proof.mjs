 ...
 *
 *   node tools/proofs/modules/202609012245-source-registry.proof.mjs
 */
...
const source = await readFile(
  join(REPO, 'atlas', 'modules', '202609012245-source-registry.js'), 'utf8');
...
const full = registry.survey({
  ...
  __GRIDATLAS_MODULES__: { gridScope: {}, networkTopology: {} },
  __GRIDATLAS_SLD__: { declared: {} }
});
