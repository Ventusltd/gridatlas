/**
 * Proof for the neon links + SLD layout sandbox cartridge, generation 202609011751.
 *
...
const CARTRIDGE = join(REPO, 'atlas', 'cartridges',
  '202609011751-sld-sandbox-v9-8.js');
